...
<body>
  ...
  <main class="bg-dark ">
    <div class="container marketing py-5">
        <h1 class="display-3 text-center text-light py-4">Aktualne promocje!</h1>
        <div class="text-center pt-2">
          <h1 class="display-5 text-light py-4">
            Być może teraz będzie cię stać na wynajem
          </h1>
        </div>
        <?php
          ...
          <div class='col'>
            <div class='card bg-dark text-light'>
              ...
              <div class='card-body'>
                ...
                <p class='card-text'>Cena: <s>100 zł</s> {$pole["cena"]} zł</p>
