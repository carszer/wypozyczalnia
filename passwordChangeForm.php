<?php
    ...
    if (isset($_POST['email']))
    {
        ...
        $emailIstnieje = $connect->query("SELECT id FROM users WHERE email='$sprawdzemail'");
        ...
        <div class="position-relative overflow-hidden p-3 p-md-5  text-center bg-light">
          <div class="col-md-5 p-lg-5 mx-auto my-5 "> 
              ...
              ?>
                ...
                <button class="w-50 btn btn-lg btn-primary" type="submit" name="utworz">Odzyskaj hasło</button>
              </div>
            </form>
