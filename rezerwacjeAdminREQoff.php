                    ...
                    <div class="col-md-5 mx-auto text-center">
                        ...
                        <form method="post" action="">
                            <div class="form-floating m-3 text-dark">
                                <select class="form-select text-dark" name="car" id="car" onchange="changeImgAndPrice()" >
                                    <?php
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="cena" name="cena"  disabled value="....">
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="name" name="name" pattern="[A-Za-z-ząćęłńóśźżĄĆĘŁŃÓŚŹŻ]{3,20}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="nazwisko" name="nazwisko" pattern="[a-zA-ZąćęłńóśźżĄĆĘŁŃÓŚŹŻ]{3,20}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="telefon" name="telefon" pattern="[0-9]{9}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="miasto" pattern="[A-Za-z]{3,20}" name="miasto" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="ulica" name="ulica" pattern="(?!\.)(?!(0))[A-Za-ząćęłńóśźżĄĆĘŁŃÓŚŹŻ0-9.-]{3,20}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="numer" name="numer" pattern="(?!(0))[0-9A-Za-z/]{1,7}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="text" class="form-control" id="prawojazdy" name="prawojazdy" pattern="(?!\.)[0-9]{5}/[0-9]{2}/[0-9]{4}" >
                            ...
                            <div class="form-floating m-3 text-dark">
                                <input type="date" name="dataod" id="dataod" class="form-control"  pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" min="<?php echo date('Y-m-d'); ?>">
                                <label for="dataod">Rezerwacja od:</label>
                            </div>

                            <div class="form-floating m-3 text-dark">
                                <input type="date" class="form-control" id="datado" name="datado"  pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" min="<?php echo date('Y-m-d'); ?>">
