  ...
  <main>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            ...
            height="850px" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h5>Dełu matiz</h5>
            <p>Super samochód na rodzinne wyprawy</p>
            <a class="btn btn-outline-secondary bg-danger text-white px-5 rounded" href="#">
              <h4>Rezerwuj</h4>
            </a>
          </div>
        </div>
        ...
        <div class="carousel-item">
          <img src="https://th.bing.com/th/id/OIP.H7ishNCs4PTUl1nV6fBn7QHaES?pid=ImgDet&rs=1" height="850px"
    ...
    <div class="position-relative text-center bg-danger ">
      <div class="col-md-5 p-lg-3 mx-auto">
        ...
        <a class="btn btn-outline-secondary bg-dark" href="oferta.html">
          <h4>Przeglądaj ofertę</h4>
        </a>
      </div>
    </div>
    <!-- Mapa kontakt -->
