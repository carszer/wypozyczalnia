    ...
    <div class="position-relative overflow-hidden p-3 p-md-5  text-center bg-dark bg-gradient">
      <div class="col-md-5 p-lg-5 mx-auto my-5 ">
        <form method="POST">
          ...
          <h1 class="h1 mb-5 fw-light text-light m-3">Rezerwacje pomyślnie usunięta</h1>
          <p1 class="p1 mb-5 fw-light text-light m-3">Zobacz rezerwacje klikając przycisk poniżej</p>
          <button type="button" class="w-50 btn btn-lg btn-warning" onclick="window.location='userDash.php'">Moje rezerwacje</button>
